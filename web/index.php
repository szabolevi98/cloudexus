...
use Cloudexus\Controller\QuoteController;
...
$router->post('/profile/sessions/end', fn() => (new ProfileController())->endSessions());
...
$router->get('/reports/crm', fn() => (new ReportController())->crm());
...
$router->get('/quotes/{id}/edit', fn($id) => (new QuoteController())->editForm((int) $id));
$router->post('/quotes/{id}', fn($id) => (new QuoteController())->update((int) $id));
$router->get('/quotes/{id}/pdf', fn($id) => (new QuoteController())->pdf((int) $id));
$router->post('/quotes/{id}/email', fn($id) => (new QuoteController())->email((int) $id));
$router->post('/quotes/{id}/sent', fn($id) => (new QuoteController())->markSent((int) $id));
$router->post('/quotes/{id}/accept', fn($id) => (new QuoteController())->accept((int) $id));
$router->post('/quotes/{id}/reject', fn($id) => (new QuoteController())->reject((int) $id));
$router->post('/quotes/{id}/order', fn($id) => (new QuoteController())->toOrder((int) $id));
$router->post('/quotes/{id}/delete', fn($id) => (new QuoteController())->delete((int) $id));
