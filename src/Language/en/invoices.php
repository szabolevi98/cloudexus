...
return [
    ...
    'pdf_page' => 'Page {PAGE_NUM} of {PAGE_COUNT}',
    'email_send' => 'Send by email',
    'email_title' => 'Send the invoice by email',
    'email_to' => 'To',
    'email_message' => 'Message',
    'email_attachment' => 'Attached: {name}',
    'email_submit' => 'Send',
    'email_subject' => 'Invoice {number}',
    'email_default_message' => "Dear Customer,\n\nPlease find attached invoice {number}. It is due on {due}.\n\nKind regards,\n{company}",
    'email_invalid' => 'Type a valid email address.',
    'email_unreachable' => 'No email goes to this address: {address}.',
    'email_queued' => 'The invoice is on its way to {address}. The email goes out within the minute.',
    'email_last' => 'Last sent: {date}, to {address}',
