...
abstract class DatabaseTestCase extends TestCase
{
    ...
    private const TABLES = [
        ...
        'partners', 'customer_groups', 'api_users', 'user_recovery_codes', 'password_resets', 'outbox', 'recent_views', 'saved_filters', 'webhook_deliveries', 'webhooks', 'deals', 'quote_items', 'quotes', 'partner_contacts', 'users',
    ];
